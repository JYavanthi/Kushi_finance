...
const Hero = () => {
  ...
  <div className="slides fade">
    <img src={endtoendsupport} alt="End to End Support" />
    <div className="caption">
      <h1>End-to-End Support</h1>
      <p>From consultation to loan disbursement, we stay with you at every step.</p>
    </div>
  </div>

  <div className="slides fade">
    <img src={financialcalculators} alt="Financial Calculators"/>
    <div className="caption">
      <h1>Financial Calculators</h1>
      <p>Plan EMIs, interest, and repayments with clarity.</p>
    </div>
  </div>

  <div className="slides fade">
    <img src={financialconsultation} alt="Financial Consultation" />
    <div className="caption">
      <h1>Financial Consultation</h1>
      <p>Clear, honest, and practical financial guidance.</p>
    </div>
  </div>

  <div className="slides fade">
    <img src={loanassistant} alt="Loan Assistance" />
    <div className="caption">
      <h1>Loan Assistance</h1>
      <p>Choose the right loan with competitive rates.</p>
    </div>
  </div>
</section> */}
      <HeroSlider />
